...
public class ExerciceTest {
    ...
    public void testSolution() {
        ...
        //assertEquals(List.of("c", "En", "Est", "moment", "le", "aller", "A", "d", "piscine", "La", "somme", "nous", "juin"), Exercice.solution("nous somme En juin, c'Est le moment d'aller A La piscine",List.of('c', 'E', 'm', 'l', 'a', 'A', 'd', 'p', 'L', 's', 'e', 'n', 'j')));
